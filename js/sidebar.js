...
// ===== Sidebar Generation =====
// Dynamically generates sidebar from WIKI_DATA and handles Updates + footer
...
function generateSidebar() {
    ...
    // Add updates section at the bottom (pushed down via CSS)
...
function createUpdatesSection() {
    ...
    updatesDiv.className = 'world-section updates-section-bottom';
...
function createUpdateItem(update) {
    ...
    updateDiv.className = 'egg-item update-item';
    updateDiv.innerHTML = `
...
// ===== Select Update =====
function selectUpdate(updateElement, update) {
...
function showWelcomePage() {
    ...
    // Remove active class from all eggs/updates
    document.querySelectorAll('.egg-item').forEach(item => {
        item.classList.remove('active');
    });
